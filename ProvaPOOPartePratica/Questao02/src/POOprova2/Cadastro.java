...
public class Cadastro {
	...
	public static void main(String[] args) {
	    ...
	    conta.adicionaDeposito("Doação:",5000,"123456789" );
		...
		while (resp.toUpperCase().equals("S")) {
			...
			else if(tipo.toUpperCase().equals("S")) {
				
				String data = JOptionPane.showInputDialog(null,"Informe o dia: ");
				conta.adicionaSaque(descricao,valor,data);
			}
